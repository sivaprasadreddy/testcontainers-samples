...
public class ProductController {
    ...
    public List<ProductResult> getProducts() throws Exception {
        ...
        List<Promotion> promotions =
                promotionServiceClient.getProductPromotionsAsync().get();
        Map<Long, Promotion> promotionsMap =
                promotions.stream().collect(Collectors.toMap(Promotion::getProductId, promotion -> promotion));
